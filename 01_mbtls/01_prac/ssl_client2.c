...
usage:
    ...
    FILE *fp_session = fopen("result_session.txt", "a");
    double connect_total_time = 0.0;
    ...
    double ele_time = (double)(ele_end - ele_start) * 1000.0 / CLOCKS_PER_SEC;
    mbedtls_printf("?붿냼 ?곌껐 ?쒓컙: %lf\n", ele_time);
    fprintf(fp_session, "%lf\n", ele_time);
